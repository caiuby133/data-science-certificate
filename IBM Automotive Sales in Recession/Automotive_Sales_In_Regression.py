...
def update_output_container(selected_statistics: str, input_year: int):
    ...
    if selected_statistics == "Recession Period Statistics":
        ...
        R_chart2 = dcc.Graph(
            figure=px.bar(
                data_frame=average_sales,
                x="Vehicle_Type",
                y="Automobile_Sales",
                title="Average Automobile Sales of Vehicles Types over Recession Period",
            )
        )
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(
                ...
                title="Total Expenditure by Vehicles Type over Recession Period",
            )
        )
